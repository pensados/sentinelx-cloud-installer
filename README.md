...
One-line installer for `sentinelx-cloud-core`. Served from `https://get.sentinelx.app`.
...
3. Installs `sentinelx-cloud-core` to `/opt/sentinelx-cloud-core`.
...
7. Installs and starts the systemd unit `sentinelx-cloud-core.service`.
...
- `sentinelx-cloud-core.service` — systemd unit template
...
```bash
sudo /opt/sentinelx-cloud-core/bin/sentinelx-enroll
```
